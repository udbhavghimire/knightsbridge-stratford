...
$mail->Host = 'mail.knightsbridge-homes.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@knightsbridge-homes.ca'; // SMTP username
$mail->Password = 'mail@knightsbridge'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@knightsbridge-homes.ca', $_POST['name']);
